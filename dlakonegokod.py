...
# warunki: starsze niz iles, 10 z rzedu dobrze, golden-shot (5 z rzedu dobrze i starsze niz 20 dni)
    ...
    ile_niepoprawnych = row_algorytm[0][3]
        #kiedy nauczone: starsze niz 2 tyg. i 8 pop. z rzeu, 24 poprawne z rzedu, starsze niz miesiac i 4 pop z rzedu i zero niepop
...
def main():
    ...
    if conn is not None:
        ...
        #test
        dlakonego=input("Musialem te linijke dojebac, zeby Ci Konczyk dzialalo, bo normalnie sie wlacza domyslnie losowanie slowka, ale w nowej bazie nie masz slowek i stack overflow wyjebie :D, a nie chce mi sie robic zeby sprawdzalo czy baza jest pusta. ;p \n Krotkie readme:\n najpierw daj '2to1', kategorie wymysl dowolna \n User ma dostep tylko do dwoch opcji: 'nauka' i 'wprowadz'. Skaczesz miedzy nimi wpisujac 'nauka' lub 'wprowadz'\n No i to tylko na jedno odpalenie jesli przez online kompilator, bo sqlite'a stracisz wylaczajac, wiec nigdy nie poznasz mocy apki \n  Napisze ci jeszcze zalozenia czemu to jest takie kot i inne od wszystkiego co jest na rynku, mimo ze wyglada jak syf pisany na kolanie: \n   *przepytuje cie o slowka niby losowe, ALE: najpierw wypierdala czesciej slowka nowe, zebys sie z nimi zapoznal \n 	potem daje 'odpoczac' i utrwalic \n	a potem jesli sie nie nauczyles, to wypierdala slowka ze zdwojona sila jak karabin, ze debil sie nauczy \n *ma kilka zalozen kiedy mozna uznac slowko za 'nauczone' \n *w kazdym miejscu ma pootwierane furtki do rozwoju (wiecej jezykow, sprawdzanie czy to nieregularny czasownik lub czy to holenderski rzeczownik, miejsce na ulepszanie algorytmu bez jebania bazy) \n *dziala i nie pierdoli nic z baza, jezeli nie ma wiecej nienauczonych slowek niz 500 czyli czesciej sie uczysz niz dodajesz, to uczy stopniowo i kozacko \n sam jestes zaskoczony, ze slowko jest w bazie, bo nie pamietasz jak dodawales, a je umiesz \n
...
def dlakonczykapierwszeodpalenie():
