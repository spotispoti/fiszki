...
def main():
    ...
    if conn is not None:
        ...
        dlakonego=input("Musialem te linijke dojebac, zeby Ci Konczyk dzialalo, bo normalnie sie wlacza domyslnie losowanie slowka, ale w nowej bazie nie masz slowek i stack overflow wyjebie :D, a nie chce mi sie robic zeby sprawdzalo czy baza jest pusta ;p Napisz 'wprowadz' i daj enter")
